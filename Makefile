# This Makefile is for the ASCII::Validate extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/ASCII/Validate.pm]
#     AUTHOR => q[Sriram Rajagopalan <rjsri@cpan.org>]
#     NAME => q[ASCII::Validate]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0] }
#     VERSION_FROM => q[lib/ASCII/Validate.pm]
#     clean => { FILES=>q[ASCII-Validate-*] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/ASCII/Validate.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DIRFILESEP)Config.pm $(PERL_INC)$(DIRFILESEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)\ASCII
INST_ARCHLIBDIR  = $(INST_ARCHLIB)\ASCII
...
TO_INST_PM = lib/ASCII/Validate.pm

PM_TO_BLIB = lib/ASCII/Validate.pm \
	blib\lib\ASCII\Validate.pm
...
DISTNAME = ASCII-Validate
DISTVNAME = ASCII-Validate-0.01
...
Validate.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"ASCII::Validate\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
manifypods : pure_all  \
	lib/ASCII/Validate.pm \
	lib/ASCII/Validate.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW)\
	  lib/ASCII/Validate.pm $(INST_MAN3DIR)\ASCII.Validate.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib\lib\ASCII\Validate.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) "name:         ASCII-Validate" >> META.yml
	$(NOECHO) $(ECHO) "version:      0.01" >> META.yml
	$(NOECHO) $(ECHO) "version_from: lib/ASCII/Validate.pm" >> META.yml
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e "pm_to_blib({@ARGV}, '$(INST_LIB)\auto', '$(PM_FILTER)')"\
	  lib/ASCII/Validate.pm blib\lib\ASCII\Validate.pm 
	$(NOECHO) $(TOUCH) $@
